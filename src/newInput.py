...
sales = predict_sales(store_id=1, date_str="2015-07-31")
print("Store 1 on 2015-07-31 Sales Prediction: $", sales, " it supposed to be 5300")
# print(f"Store 1 on 2014-05-05 Sales Prediction: ${sales:.2f}")
